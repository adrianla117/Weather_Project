...
SECRET_KEY = 'django-insecure-@v((y9zfxfs=+5b)zr)r*k9p18updy8or(0)j@oc$ai(=k6a-i'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'clima/static')]
...
LOGIN_REDIRECT_URL = 'home' #Para redirigir al usuario a la página de inicio después de iniciar sesión
LOGOUT_REDIRECT_URL = 'home' #Para redirigir al usuario a la página de inicio después de cerrar sesión